...
alias update-kde-packages='sudo scratch upgrade -c dolphin kate konsole kpat ksirk kmahjongg kcalc dolphin-plugins ffmpegthumbs kapman kdeconnect-kde kdegraphics-thumbnailers khelpcenter kio-extras kmines kmix knavalbattle knetwalk knights kolf ksudoku libkcddb libkdcraw libkdegames libexiv2 libkmahjongg okular polkit-kde-agent-1 palapeli'
# End ~/.bashrc
complete -cf sudo
eval "$(thefuck --alias)"
